...
const pageIcons: Record<MarketingPageSlug, LucideIcon> = {
  'estrategias-digitales': Target,
  'gestion-de-redes-sociales': Share2,
  'community-management': Users,
  'campanas-publicitarias': Megaphone,
      ...
      <section className="bg-black px-5 py-16 text-white md:px-10 xl:px-20">
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <div>
            ...
            <p className="mt-8 max-w-xl text-lg leading-8 text-white/62">{page.intro}</p>

            <div className="mt-10 grid max-w-lg grid-cols-2 gap-px bg-white/10">
              <div className="bg-black p-5">
                <Icon className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">{page.featureOne}</p>
              </div>
              <div className="bg-black p-5">
                <BarChart3 className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">{page.featureTwo}</p>
              </div>
            </div>
          </div>
      ...
      <section className="px-5 py-16 md:px-10 xl:px-20">
        <div className="mx-auto grid max-w-6xl gap-px bg-black/10 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="bg-white p-6 md:p-10">
            ...
            <p className="mt-6 text-base leading-8 text-black/62">{page.whatText}</p>
          </div>
