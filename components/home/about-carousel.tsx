...
const aboutSlides = [
  {
    ...
    text: 'Somos una agencia de marketing, diseno y tecnologia que ayuda a empresas e instituciones a comunicar mejor, verse profesionales y crecer con estrategia.',
    stat: '10+',
  ...
  },
  {
    number: '02',
    title: 'Mision',
    text: 'Acompanamos marcas con soluciones creativas, digitales y medibles para que puedan vender mejor, fortalecer su identidad y conectar con su audiencia.',
    stat: '360',
  ...
  },
  {
    number: '03',
    title: 'Vision',
    text: 'Ser una agencia referente en Colombia para negocios que buscan presencia digital profesional, comunicacion clara y crecimiento sostenible.',
    stat: 'CO',
  ...
  },
  {
    ...
    text: 'Unimos estrategia, diseno, desarrollo web, produccion audiovisual e inteligencia artificial para construir soluciones completas, no piezas aisladas.',
    stat: '5',
    statLabel: 'areas conectadas',
  },
] as const;
      ...
      <div className="grid gap-px overflow-hidden border border-white/10 bg-white/10 lg:grid-cols-[0.82fr_1.18fr]">
        <div className="bg-[#05070b] p-6 md:p-10 xl:p-12">
          ...
          <h2 className="font-display mt-6 max-w-xl text-4xl leading-none font-black tracking-normal md:text-5xl">
            Estrategia, creatividad y tecnologia para marcas que quieren{' '}
            <span className="text-blue-600">crecer.</span>
          </h2>
          <p className="mt-7 max-w-lg text-sm leading-7 text-white/55">
            Antes de hablar de servicios, esto es lo que somos: una agencia que combina
            pensamiento estrategico, ejecucion visual y herramientas digitales para crear
            presencia real.
          </p>
