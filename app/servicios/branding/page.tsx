import { ArrowUpRight, BadgeCheck, Palette, Sparkles, Target } from 'lucide-react';
import Image from 'next/image';
import Link from 'next/link';
import { SiteFooter } from '@/components/layout/site-footer';
import { brandingPage } from '@/data/services/diseno';
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <div>
            ...
            <h1 className="font-display mt-6 text-[clamp(3rem,6vw,6rem)] leading-[0.92] font-black tracking-normal">
              Branding para marcas que necesitan una dirección clara.
            </h1>
            <p className="mt-8 max-w-xl text-lg leading-8 text-white/62">
              Definimos la personalidad visual y estratégica de tu marca para que se vea,
              se sienta y comunique con coherencia en cada punto de contacto.
            </p>

            <div className="mt-10 grid max-w-lg grid-cols-2 gap-px bg-white/10">
              <div className="bg-black p-5">
                <Target className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">Dirección estratégica</p>
              </div>
              <div className="bg-black p-5">
                <Palette className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">Sistema visual</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative min-h-[420px] overflow-hidden bg-zinc-950 shadow-[0_30px_90px_rgba(37,99,235,0.18)] lg:min-h-[560px]">
            ...
            <div className="absolute right-6 bottom-6 left-6">
              ...
              <p className="font-display mt-3 max-w-sm text-3xl leading-none font-black">
                Una marca fuerte empieza con una dirección clara.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-px bg-black/10 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="bg-white p-6 md:p-10">
            ...
            <p className="mt-6 text-base leading-8 text-black/62">
              Construimos una base de marca que une estrategia, personalidad y estilo
              visual. El objetivo es que la marca tenga una forma reconocible de hablar,
              verse y presentarse.
            </p>
          </div>
          ...
          <div className="bg-white p-6 md:p-10">
            ...
            <h2 className="font-display mt-5 text-4xl leading-none font-black">
              Una marca sin dirección se vuelve difícil de recordar.
            </h2>
            <p className="mt-6 text-base leading-8 text-black/62">
              El branding ayuda a tomar decisiones visuales y comunicativas con criterio.
              Cuando una marca tiene una base clara, cada pieza posterior se diseña con
              más coherencia y menos improvisación.
            </p>
          </div>
        </div>

        <div className="mx-auto mt-px grid max-w-6xl gap-px bg-black/10 md:grid-cols-2">
          {brandingPage.deliverables.map((item) => (
            <div
              key={item}
        ...
        <div className="mx-auto max-w-6xl border-t border-black/10 pt-14">
          <div className="grid gap-8 lg:grid-cols-[0.55fr_1.45fr]">
            <div>
              ...
              <h2 className="font-display mt-5 text-4xl leading-none font-black">
                El branding se construye según madurez y objetivo.
              </h2>
            </div>

            <div className="grid gap-4 md:grid-cols-3">
              {brandingPage.packages.map((item) => (
                <article
                  key={item.name}
      ...
      <section className="bg-black px-5 py-16 text-white md:px-10 xl:px-20">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-4">
            {brandingPage.process.map(([number, title, text]) => (
