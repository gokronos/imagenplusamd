...
import { disenoGraficoPage } from '@/data/services/diseno';
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <div>
            ...
            <h1 className="font-display mt-6 text-[clamp(3rem,6vw,6rem)] leading-[0.92] font-black tracking-normal">
              Diseño gráfico para marcas que necesitan verse claras.
            </h1>
            <p className="mt-8 max-w-xl text-lg leading-8 text-white/62">
              Convertimos ideas, ofertas y mensajes en piezas visuales listas para redes,
              impresión, presentaciones y campañas comerciales.
            </p>
            ...
            <div className="mt-10 grid max-w-lg grid-cols-2 gap-px bg-white/10">
              ...
              <div className="bg-black p-5">
                ...
                <p className="mt-4 text-sm font-black">Formatos adaptables</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative min-h-[420px] overflow-hidden bg-zinc-950 shadow-[0_30px_90px_rgba(37,99,235,0.18)] lg:min-h-[560px]">
            ...
            <div className="absolute right-6 bottom-6 left-6">
              ...
              <p className="font-display mt-3 max-w-sm text-3xl leading-none font-black">
                Piezas pensadas para comunicar, vender y recordar.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-px bg-black/10 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="bg-white p-6 md:p-10">
            ...
            <p className="mt-6 text-base leading-8 text-black/62">
              Creamos piezas que ordenan la información, respetan la identidad de la marca
              y ayudan a que el mensaje se vea profesional. Cada diseño debe guiar la
              mirada y dejar claro qué se quiere comunicar.
            </p>
          </div>
          ...
          <div className="bg-white p-6 md:p-10">
            ...
            <h2 className="font-display mt-5 text-4xl leading-none font-black">
              Una marca se recuerda mejor cuando comunica con orden.
            </h2>
            <p className="mt-6 text-base leading-8 text-black/62">
              Un buen diseño ayuda a que una empresa se perciba más confiable, organizada
              y preparada. También reduce improvisación: cada pieza mantiene una línea
              visual y permite publicar, vender o presentar con más seguridad.
            </p>
          </div>
        </div>

        <div className="mx-auto mt-px grid max-w-6xl gap-px bg-black/10 md:grid-cols-2">
          {disenoGraficoPage.deliverables.map((item) => (
            <div
              key={item}
        ...
        <div className="mx-auto max-w-6xl border-t border-black/10 pt-14">
          <div className="grid gap-8 lg:grid-cols-[0.55fr_1.45fr]">
            <div>
              ...
              <h2 className="font-display mt-5 text-4xl leading-none font-black">
                El alcance se ajusta a lo que la marca necesita.
              </h2>
            </div>

            <div className="grid gap-4 md:grid-cols-3">
              {disenoGraficoPage.packages.map((item) => (
                <article
                  key={item.name}
      ...
      <section className="bg-black px-5 py-16 text-white md:px-10 xl:px-20">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-4">
            {disenoGraficoPage.process.map(([number, title, text]) => (
