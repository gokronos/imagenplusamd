...
import { publicidadImpresaPage } from '@/data/services/diseno';

export default function PublicidadImpresaPage() {
  return (
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <div>
            ...
            <h1 className="font-display mt-6 text-[clamp(3rem,6vw,6rem)] leading-[0.92] font-black tracking-normal">
              Publicidad impresa para comunicar ofertas con impacto.
            </h1>
            <p className="mt-8 max-w-xl text-lg leading-8 text-white/62">
              Diseñamos volantes, afiches, pendones, plegables y materiales impresos con
              mensajes claros, buena jerarquia visual y preparacion para produccion.
            </p>

            <div className="mt-10 grid max-w-lg grid-cols-2 gap-px bg-white/10">
              <div className="bg-black p-5">
                <Megaphone className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">Mensaje visible</p>
              </div>
              <div className="bg-black p-5">
                <Printer className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">Arte final listo</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative min-h-[420px] overflow-hidden bg-zinc-950 shadow-[0_30px_90px_rgba(37,99,235,0.18)] lg:min-h-[560px]">
            <Image
              src={publicidadImpresaPage.visual}
              alt=""
              fill
            ...
            <div className="absolute right-6 bottom-6 left-6">
              ...
              <p className="font-display mt-3 max-w-sm text-3xl leading-none font-black">
                Materiales preparados para verse bien y producirse mejor.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-px bg-black/10 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="bg-white p-6 md:p-10">
            ...
            <p className="mt-6 text-base leading-8 text-black/62">
              Creamos piezas impresas que ordenan la informacion y destacan lo importante:
              oferta, beneficio, llamado a la accion y datos de contacto. Cada diseño se
              prepara segun medidas, soporte y objetivo comercial.
            </p>
          </div>
          ...
          <div className="bg-white p-6 md:p-10">
            ...
            <h2 className="font-display mt-5 text-4xl leading-none font-black">
              Lo impreso sigue vendiendo cuando esta bien diseñado.
            </h2>
            <p className="mt-6 text-base leading-8 text-black/62">
              Una pieza impresa clara puede llevar trafico, explicar una promocion,
              reforzar una campaña o hacer visible una marca en espacios fisicos. El
              diseño evita que el mensaje se pierda entre demasiada informacion.
            </p>
          </div>
        </div>

        <div className="mx-auto mt-px grid max-w-6xl gap-px bg-black/10 md:grid-cols-2">
          {publicidadImpresaPage.deliverables.map((item) => (
            <div
              key={item}
        ...
        <div className="mx-auto max-w-6xl border-t border-black/10 pt-14">
          <div className="grid gap-8 lg:grid-cols-[0.55fr_1.45fr]">
            <div>
              ...
              <h2 className="font-display mt-5 text-4xl leading-none font-black">
                El alcance cambia segun campaña, formato y produccion.
              </h2>
            </div>

            <div className="grid gap-4 md:grid-cols-3">
              {publicidadImpresaPage.packages.map((item) => (
                <article
                  key={item.name}
      ...
      <section className="bg-black px-5 py-16 text-white md:px-10 xl:px-20">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-4">
            {publicidadImpresaPage.process.map(([number, title, text]) => (
