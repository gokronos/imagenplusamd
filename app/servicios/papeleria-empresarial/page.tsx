...
import { papeleriaEmpresarialPage } from '@/data/services/diseno';

export default function PapeleriaEmpresarialPage() {
  return (
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <div>
            ...
            <h1 className="font-display mt-6 text-[clamp(3rem,6vw,6rem)] leading-[0.92] font-black tracking-normal">
              Papelería empresarial para una marca más ordenada.
            </h1>
            <p className="mt-8 max-w-xl text-lg leading-8 text-white/62">
              Diseñamos piezas corporativas impresas y digitales para que cada documento,
              propuesta, contacto y entrega mantenga la misma presencia profesional.
            </p>

            <div className="mt-10 grid max-w-lg grid-cols-2 gap-px bg-white/10">
              <div className="bg-black p-5">
                <FileText className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">Documentos claros</p>
              </div>
              <div className="bg-black p-5">
                <FolderOpen className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">Material organizado</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative min-h-[420px] overflow-hidden bg-zinc-950 shadow-[0_30px_90px_rgba(37,99,235,0.18)] lg:min-h-[560px]">
            <Image
              src={papeleriaEmpresarialPage.visual}
              alt=""
              fill
            ...
            <div className="absolute right-6 bottom-6 left-6">
              ...
              <p className="font-display mt-3 max-w-sm text-3xl leading-none font-black">
                Cada documento también comunica la calidad de tu empresa.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-px bg-black/10 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="bg-white p-6 md:p-10">
            ...
            <p className="mt-6 text-base leading-8 text-black/62">
              Creamos piezas corporativas que ayudan a presentar, vender, cotizar y
              comunicarse con una imagen más sólida. La papelería ordena la marca en los
              formatos que la empresa usa todos los días.
            </p>
          </div>
          ...
          <div className="bg-white p-6 md:p-10">
            ...
            <h2 className="font-display mt-5 text-4xl leading-none font-black">
              La presentación también vende confianza.
            </h2>
            <p className="mt-6 text-base leading-8 text-black/62">
              Una propuesta, tarjeta o documento bien diseñado hace que la empresa se vea
              más seria y preparada. También facilita que el equipo use materiales
              consistentes sin improvisar cada pieza.
            </p>
          </div>
        </div>

        <div className="mx-auto mt-px grid max-w-6xl gap-px bg-black/10 md:grid-cols-2">
          {papeleriaEmpresarialPage.deliverables.map((item) => (
            <div
              key={item}
        ...
        <div className="mx-auto max-w-6xl border-t border-black/10 pt-14">
          <div className="grid gap-8 lg:grid-cols-[0.55fr_1.45fr]">
            <div>
              ...
              <h2 className="font-display mt-5 text-4xl leading-none font-black">
                La papelería puede crecer según la operación.
              </h2>
            </div>

            <div className="grid gap-4 md:grid-cols-3">
              {papeleriaEmpresarialPage.packages.map((item) => (
                <article
                  key={item.name}
      ...
      <section className="bg-black px-5 py-16 text-white md:px-10 xl:px-20">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-4">
            {papeleriaEmpresarialPage.process.map(([number, title, text]) => (
          ...
          >
            Solicitar papelería empresarial
            <Sparkles size={16} />
          </Link>
        </div>
      </section>
