...
import { materialPopPage } from '@/data/services/diseno';
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <div>
            ...
            <h1 className="font-display mt-6 text-[clamp(3rem,6vw,6rem)] leading-[0.92] font-black tracking-normal">
              Material POP para destacar en espacios comerciales.
            </h1>
            <p className="mt-8 max-w-xl text-lg leading-8 text-white/62">
              Diseñamos piezas para punto de venta que ayudan a comunicar promociones,
              destacar productos y reforzar la presencia visual de la marca.
            </p>

            <div className="mt-10 grid max-w-lg grid-cols-2 gap-px bg-white/10">
              <div className="bg-black p-5">
                <Tag className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">Promoción visible</p>
              </div>
              <div className="bg-black p-5">
                <PanelsTopLeft className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">Exhibición clara</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative min-h-[420px] overflow-hidden bg-zinc-950 shadow-[0_30px_90px_rgba(37,99,235,0.18)] lg:min-h-[560px]">
            ...
            <div className="absolute right-6 bottom-6 left-6">
              ...
              <p className="font-display mt-3 max-w-sm text-3xl leading-none font-black">
                Piezas que ayudan a vender donde ocurre la decisión.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-px bg-black/10 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="bg-white p-6 md:p-10">
            ...
            <p className="mt-6 text-base leading-8 text-black/62">
              Diseñamos piezas para exhibición, promoción y comunicación física. Cada
              material se adapta al producto, al espacio y al tipo de producción para que
              funcione en el punto de venta real.
            </p>
          </div>
          ...
          <div className="bg-white p-6 md:p-10">
            ...
            <h2 className="font-display mt-5 text-4xl leading-none font-black">
              El punto de venta también necesita diseño.
            </h2>
            <p className="mt-6 text-base leading-8 text-black/62">
              Un buen material POP ayuda a guiar la mirada, destacar promociones y mejorar
              la percepción del producto. En espacios comerciales, el diseño puede hacer
              que una oferta se note o pase desapercibida.
            </p>
          </div>
        </div>

        <div className="mx-auto mt-px grid max-w-6xl gap-px bg-black/10 md:grid-cols-2">
          {materialPopPage.deliverables.map((item) => (
            <div
              key={item}
        ...
        <div className="mx-auto max-w-6xl border-t border-black/10 pt-14">
          <div className="grid gap-8 lg:grid-cols-[0.55fr_1.45fr]">
            <div>
              ...
              <h2 className="font-display mt-5 text-4xl leading-none font-black">
                El material se define según campaña y producción.
              </h2>
            </div>

            <div className="grid gap-4 md:grid-cols-3">
              {materialPopPage.packages.map((item) => (
                <article
                  key={item.name}
      ...
      <section className="bg-black px-5 py-16 text-white md:px-10 xl:px-20">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-4">
            {materialPopPage.process.map(([number, title, text]) => (
