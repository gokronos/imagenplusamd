...
import { manualMarcaPage } from '@/data/services/diseno';
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <div>
            ...
            <h1 className="font-display mt-6 text-[clamp(3rem,6vw,6rem)] leading-[0.92] font-black tracking-normal">
              Manual de marca para aplicar tu identidad con orden.
            </h1>
            <p className="mt-8 max-w-xl text-lg leading-8 text-white/62">
              Documentamos las reglas visuales de tu marca para que cada pieza, proveedor
              y canal mantenga una comunicacion coherente y profesional.
            </p>

            <div className="mt-10 grid max-w-lg grid-cols-2 gap-px bg-white/10">
              <div className="bg-black p-5">
                <ClipboardCheck className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">Reglas claras</p>
              </div>
              <div className="bg-black p-5">
                <Palette className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">Identidad consistente</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative min-h-[420px] overflow-hidden bg-zinc-950 shadow-[0_30px_90px_rgba(37,99,235,0.18)] lg:min-h-[560px]">
            ...
            <div className="absolute right-6 bottom-6 left-6">
              ...
              <p className="font-display mt-3 max-w-sm text-3xl leading-none font-black">
                Una marca ordenada se aplica mejor en cualquier canal.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-px bg-black/10 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="bg-white p-6 md:p-10">
            ...
            <p className="mt-6 text-base leading-8 text-black/62">
              Creamos un documento practico que define como debe usarse la marca: logo,
              color, tipografia, composicion, recursos graficos y aplicaciones
              principales. La idea es que la identidad no dependa de interpretaciones
              sueltas.
            </p>
          </div>
          ...
          <div className="bg-white p-6 md:p-10">
            ...
            <h2 className="font-display mt-5 text-4xl leading-none font-black">
              Una marca documentada se mantiene fuerte con el tiempo.
            </h2>
            <p className="mt-6 text-base leading-8 text-black/62">
              El manual evita usos improvisados, ayuda a trabajar con proveedores y
              permite que el equipo mantenga una linea visual consistente en documentos,
              redes, piezas comerciales y materiales impresos.
            </p>
          </div>
        </div>

        <div className="mx-auto mt-px grid max-w-6xl gap-px bg-black/10 md:grid-cols-2">
          {manualMarcaPage.deliverables.map((item) => (
            <div
              key={item}
        ...
        <div className="mx-auto max-w-6xl border-t border-black/10 pt-14">
          <div className="grid gap-8 lg:grid-cols-[0.55fr_1.45fr]">
            <div>
              ...
              <h2 className="font-display mt-5 text-4xl leading-none font-black">
                El manual se ajusta al nivel de uso de la marca.
              </h2>
            </div>

            <div className="grid gap-4 md:grid-cols-3">
              {manualMarcaPage.packages.map((item) => (
                <article
                  key={item.name}
      ...
      <section className="bg-black px-5 py-16 text-white md:px-10 xl:px-20">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-4">
            {manualMarcaPage.process.map(([number, title, text]) => (
