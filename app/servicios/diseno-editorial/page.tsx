...
import { disenoEditorialPage } from '@/data/services/diseno';
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <div>
            ...
            <h1 className="font-display mt-6 text-[clamp(3rem,6vw,6rem)] leading-[0.92] font-black tracking-normal">
              Diseño editorial para contenidos que necesitan orden.
            </h1>
            <p className="mt-8 max-w-xl text-lg leading-8 text-white/62">
              Convertimos documentos, catálogos e informes en piezas claras, legibles y
              visualmente consistentes para impresión o distribución digital.
            </p>

            <div className="mt-10 grid max-w-lg grid-cols-2 gap-px bg-white/10">
              <div className="bg-black p-5">
                <LayoutTemplate className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">Retícula clara</p>
              </div>
              <div className="bg-black p-5">
                <BookOpen className="text-blue-500" size={24} />
                <p className="mt-4 text-sm font-black">Lectura organizada</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative min-h-[420px] overflow-hidden bg-zinc-950 shadow-[0_30px_90px_rgba(37,99,235,0.18)] lg:min-h-[560px]">
            <Image
              src={disenoEditorialPage.visual}
              alt=""
              fill
            ...
            <div className="absolute right-6 bottom-6 left-6">
              ...
              <p className="font-display mt-3 max-w-sm text-3xl leading-none font-black">
                La estructura correcta hace que el contenido respire.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-px bg-black/10 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="bg-white p-6 md:p-10">
            ...
            <p className="mt-6 text-base leading-8 text-black/62">
              Diseñamos sistemas de páginas que ayudan a leer mejor: jerarquías, márgenes,
              retículas, estilos, imágenes y llamados visuales. Cada página debe guiar al
              lector sin perder identidad de marca.
            </p>
          </div>
          ...
          <div className="bg-white p-6 md:p-10">
            ...
            <h2 className="font-display mt-5 text-4xl leading-none font-black">
              Un buen documento también construye marca.
            </h2>
            <p className="mt-6 text-base leading-8 text-black/62">
              Cuando un catálogo, informe o brochure está bien diagramado, el contenido se
              entiende mejor y la empresa se percibe más profesional. La forma de
              presentar información influye directamente en cómo se interpreta.
            </p>
          </div>
        </div>

        <div className="mx-auto mt-px grid max-w-6xl gap-px bg-black/10 md:grid-cols-2">
          {disenoEditorialPage.deliverables.map((item) => (
            <div
              key={item}
        ...
        <div className="mx-auto max-w-6xl border-t border-black/10 pt-14">
          <div className="grid gap-8 lg:grid-cols-[0.55fr_1.45fr]">
            <div>
              ...
              <h2 className="font-display mt-5 text-4xl leading-none font-black">
                El formato depende del volumen y el uso.
              </h2>
            </div>

            <div className="grid gap-4 md:grid-cols-3">
              {disenoEditorialPage.packages.map((item) => (
                <article
                  key={item.name}
      ...
      <section className="bg-black px-5 py-16 text-white md:px-10 xl:px-20">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-4">
            {disenoEditorialPage.process.map(([number, title, text]) => (
